...
export class AdminProductsComponent implements OnInit {
  ...
  loadData() {
    ...
    this.adminService.getProducts().subscribe((data: any) => this.products = data);
    this.adminService.getCategories().subscribe((data: any) => this.categories = data);
  }
  ...
  saveProduct() {
    ...
    request.subscribe({
      ...
      error: (err: any) => Swal.fire('Error', err.error?.message || 'Error al guardar', 'error')
    });
  }
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.adminService.deleteProduct(product.productoId || product.id).subscribe({
          ...
          error: (err: any) => Swal.fire('Error', 'No se puede eliminar (posiblemente tiene pedidos asociados)', 'error')
        });
      }
    });
  }
